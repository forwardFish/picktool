...
def write_outputs(results: list[dict[str, object]]) -> None:
    ...
    json_path = QA_RESULTS / "sprint_4_delivery_results.json"
    md_path = SPRINT_ACCEPTANCE / "sprint_4_delivery_report.md"
...
def main() -> int:
    steps = [
        ...
        ("api_smoke", "node scripts\\run_sprint4_smoke.mjs", 420),
        ("browser_smoke", "node scripts\\run_sprint4_browser_smoke.mjs", 480),
    ]
