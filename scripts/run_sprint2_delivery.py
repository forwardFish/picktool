...
def write_outputs(results: list[dict[str, object]]) -> None:
    ...
    json_path = QA_RESULTS / "sprint_2_delivery_results.json"
    md_path = SPRINT_ACCEPTANCE / "sprint_2_delivery_report.md"
...
def main() -> int:
    steps = [
        ...
        ("api_smoke", "node scripts\\run_sprint2_smoke.mjs", 240),
        ("browser_smoke", "node scripts\\run_sprint2_browser_smoke.mjs", 360),
    ]
