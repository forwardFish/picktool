...
def write_outputs(results: list[dict[str, object]]) -> None:
    ...
    json_path = QA_RESULTS / "sprint_1_delivery_results.json"
    md_path = SPRINT_ACCEPTANCE / "sprint_1_delivery_report.md"
...
def main() -> int:
    steps = [
        ...
        ("http_smoke", "node scripts\\run_sprint1_smoke.mjs", 180),
        ("browser_smoke", "node scripts\\run_sprint1_browser_smoke.mjs", 240),
    ]
