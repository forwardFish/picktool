...
def write_outputs(results: list[dict[str, object]]) -> None:
    ...
    json_path = QA_RESULTS / "sprint_5_delivery_results.json"
    md_path = SPRINT_ACCEPTANCE / "sprint_5_delivery_report.md"
...
def main() -> int:
    steps = [
        ...
        ("api_smoke", "node scripts\\run_sprint5_share_history_smoke.mjs", 480),
        ("browser_smoke", "node scripts\\run_sprint5_browser_smoke.mjs", 720),
    ]
